...
# Removed async dependencies for scheduler compatibility
...
def identify_new_leads():
    ...
    # Fetch and analyze articles - use synchronous version
    articles = []
    ...
    print(f"Collected {len(articles)} tech-relevant articles for analysis")
